...
import com.kivo.api.aplicacao.dto.CambioDTO;
...
@Component
public class ClienteBrasilApi {

    private static final Logger log = LoggerFactory.getLogger(ClienteBrasilApi.class);

    private final RestClient restClient;
    private final DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");

    public ClienteBrasilApi(@Qualifier("brasilApiRestClient") RestClient restClient) {
